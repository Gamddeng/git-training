...
Node *insertNode(Node* node, int data) {
    if (!node) {
        if (data==21) printf("!node");
        if (data==21) printf("!node %d\n", data);
        ...
        if (data==21) printf("data < node->data 1%d\n", node->data);
        node->leftChild=insertNode(node->leftChild, data);
        if (data==21) printf("data < node->data 2%d\n", node->data);
        node = balance(node);
        if (data==21) printf("data < node->data 3%d\n", node->data);
    }
    else if (data > node->data) {
        if (data == 21) printf("data > node->data %d\n", node->data);
